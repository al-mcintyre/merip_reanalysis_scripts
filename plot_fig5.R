...
peak.table <- read.csv2('fig5/peak_table.csv',sep=' ')
merip_rt_qpcr_results = as.data.frame(read.csv('fig5/merip_rtqpcr_summary_by_gene.txt',header=TRUE,sep="\t"))
...
pdf("fig5/sfig5_merip_seq_vs_rtqpcr.pdf",height = 5.2,width=5)
...
pdf("fig5/fig5_merip_seq_vs_rtqpcr_all.pdf",height = 3.5,width=3.5)
...
pdf("fig5/sfig5_merip_seq_vs_rtqpcr_bar.pdf",height = 5,width=7)
